  ...
  <div>
    <p>{{langKey('按钮大小')}}</p>
      <yo-button-group>
            ...
            <yo-button :class="{'active':btnSize=='m'}" @click="switchSize('m')">{{langKey('中等按钮')}}</yo-button>
            <yo-button :class="{'active':btnSize=='s'}" @click="switchSize('s')">{{langKey('小型按钮')}}</yo-button>
            <yo-button :class="{'active':btnSize=='xs'}" @click="switchSize('xs')">{{langKey('超小按钮')}}</yo-button>
        </yo-button-group>
